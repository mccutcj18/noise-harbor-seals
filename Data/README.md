...
- `bellingham_bay_2023.06.01_2024.02.26.nc`: This contains the LiveOcean model's output (MacCready et al. 2021) from 05/31/2023 to 02/26/2024.
- `bellingham_bay_2024.02.26_2024.06.08.nc`: This contains the LiveOcean model's output (MacCready et al. 2021) from 02/26/2024 to 06/08/2024.
